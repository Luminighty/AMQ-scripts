...
// @updateURL    https://raw.githubusercontent.com/Luminighty/AMQ-scripts/main/emq-mass-download.js
// @grant        none
// ==/UserScript==
...
async function setup() {
	...
	if (!nav) return;
	if (nav.querySelector(".download-link")) return;
	const item = document.createElement("li")
	item.classList.add("nav-item")
	item.classList.add("download-link")
